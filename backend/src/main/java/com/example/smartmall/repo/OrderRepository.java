...
public interface OrderRepository extends JpaRepository<Order, Long> {
  ...
  @Query("""
      update Order o set o.status = :nextStatus
      where o.id = :id and o.userId = :userId and o.status = :expectedStatus
      """)
  int transitionOwnStatus(@Param("id") Long id,
  ...
  @Modifying(flushAutomatically = true, clearAutomatically = true)
  @Query("""
      update Order o set o.status = 'PAID', o.paidAt = :paidAt
      where o.id = :id and o.userId = :userId and o.status = 'PENDING_PAYMENT'
      """)
  int markOwnPaid(@Param("id") Long id, @Param("userId") Long userId, @Param("paidAt") LocalDateTime paidAt);
