...
VALUES
  ...
  (6, 9, 2, 1, 5, '放在通勤包里用了两周，接头没有松动，给手机和扩展坞供电都稳定。', '2026-07-04 11:10:00'),
  (7, 9, 3, 2, 4, '编织外被抗弯折，桌面走线不容易缠在一起，适合办公桌长期插着用。', '2026-07-04 11:45:00'),
  (8, 15, 3, 3, 4, '键程比普通赠品键盘舒服，声音比较克制，适合宿舍和图书馆旁边的自习区。', '2026-07-04 14:05:00'),
  (9, 15, 2, 4, 5, '给家里旧电脑配的，安装即用，预算很低但日常写文档完全够。', '2026-07-04 14:40:00'),
  (10, 3, 2, 5, 5, '鼠标很轻，长时间修图手腕负担小，侧键位置也不容易误触。', '2026-07-04 16:30:00'),
  (11, 3, 3, 6, 4, 'DPI 调节范围大，游戏和办公能切换，脚贴顺滑但手大的人可能需要适应。', '2026-07-04 17:10:00'),
  (12, 8, 2, 1, 5, '一个充电器同时给笔记本和手机补电，出差少带了两个头，发热在可接受范围。', '2026-07-05 09:20:00'),
  (13, 8, 3, 2, 4, '三口同时用时速度会分配，但会议室临时补电很方便，体积比原装适配器小。', '2026-07-05 10:05:00'),
  (14, 11, 2, 3, 5, '给台灯设置了定时开关，App 里能看到用电情况，适合宿舍和出租屋。', '2026-07-05 11:30:00'),
  (15, 11, 3, 4, 4, '配网一次成功，远程关插座很省心，插头间距稍紧但不影响单个设备使用。', '2026-07-05 12:15:00'),
  (16, 58, 2, 5, 5, '跳绳计数比较准，手柄防滑，晚上在家训练声音也不大。', '2026-07-05 15:10:00'),
  (17, 58, 3, 6, 4, '计数屏幕直观，适合给健身新手做目标提醒，绳长调整需要一点耐心。', '2026-07-05 15:45:00'),
  (18, 46, 2, 1, 5, '铝合金支架放 6.7 英寸手机很稳，视频会议打字时屏幕不会明显晃。', '2026-07-06 09:15:00'),
  (19, 46, 3, 2, 4, '折叠后很薄，放包里不占地方，追剧角度调节够用，底部防滑垫比较稳。', '2026-07-06 09:50:00'),
  (20, 4, 2, 3, 5, '4K 分辨率写代码很清楚，Type-C 一线连笔记本很省桌面空间。', '2026-07-06 10:25:00'),
  (21, 4, 3, 4, 4, 'IPS 色彩稳定，分屏看文档和浏览器很舒服，支架升降幅度够日常办公。', '2026-07-06 11:05:00'),
  (22, 18, 2, 5, 4, '显示器下面能放键盘和便签，桌面清爽很多，木纹外观比较耐看。', '2026-07-06 13:20:00'),
  (23, 18, 3, 6, 5, '承重放 27 英寸显示器没问题，底部空间够收纳扩展坞和数据线。', '2026-07-06 14:00:00'),
  (24, 20, 2, 1, 4, '磁吸定位准确，通勤路上补电方便，手机壳太厚时吸力会下降。', '2026-07-06 15:30:00'),
  (25, 20, 3, 2, 5, '容量够一天临时补电，放小包里不笨重，适合送给经常外出的朋友。', '2026-07-06 16:05:00'),
  (26, 31, 2, 3, 5, '刷牙计时提醒很实用，五档模式里敏感档比较温和，适合作为实用礼物。', '2026-07-06 17:10:00'),
  (27, 31, 3, 4, 4, '续航比预期好，旅行带一周不用充电，机身握持不滑。', '2026-07-06 17:45:00'),
  (28, 43, 2, 5, 5, '贴纸和索引页很适合做课程计划，纸张写中性笔不容易洇。', '2026-07-07 09:05:00'),
  (29, 43, 3, 6, 4, '送同学当开学礼物很合适，页面设计清爽，适合项目排期和打卡。', '2026-07-07 09:40:00'),
  (30, 50, 2, 1, 5, '双模切换很快，微动声音轻，办公室连续用一天手也不累。', '2026-07-07 10:30:00')
ON DUPLICATE KEY UPDATE
  product_id = VALUES(product_id),
  user_id = VALUES(user_id),
  order_id = VALUES(order_id),
